...
* Questions about the algorithms should be directed to their authors,
...
public class Stemmer {
   ...
   */
   ...
   /* step6() removes a final -e if m() > 1. */
    ...
    /**
     * Method to read words from string and transform them to their root form.
     *
     */
    public static ArrayList<String> readString(String word) {
        ArrayList<String> cleaned_Vocabulary = new ArrayList<String>();
                    ...
                    while (true) {
                        ...
                        if (!Character.isLetter((char) ch)) {
                            ...
                            /* or, to test add(char[] w, int j) */
                             /* s.add(w, j); */
                            s.stem();
                            cleaned_Vocabulary.add(s.toString());
                            break;
                        }
                    }
                }
